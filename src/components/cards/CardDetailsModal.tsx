...
import { SwordIcon, ShieldIcon, SparklesIcon, ZapIcon } from "@/components/icons/Elements";
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-xl">
        ...
        >
          ...
          <div className="flex items-center justify-between border-b border-zinc-800/80 pb-4">
            ...
            <button
              onClick={onClose}
              className="h-8 w-8 rounded-full bg-zinc-800/80 text-zinc-400 hover:text-white hover:bg-zinc-700 flex items-center justify-center transition-colors"
            >
              ✕
            </button>
          </div>
