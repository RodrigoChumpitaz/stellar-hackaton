        ...
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
          ...
          >
            ...
            <div className="mt-4 space-y-2.5">
              {/* Option 1: Quick Play (Mobile Favorite) */}
              <button
                type="button"
                disabled={wallet.isConnecting}
                onClick={handleQuickPlay}
                className="w-full text-left group relative overflow-hidden rounded-2xl border border-cyan-500/40 bg-gradient-to-r from-cyan-950/40 to-blue-950/30 p-3.5 hover:border-cyan-400 active:scale-[0.98] transition-all cursor-pointer disabled:opacity-50"
              >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[11px] sm:text-xs text-zinc-400 mt-0.5">
                        Fondea una cuenta en Testnet al instante. Cero extensiones.
                      </p>
                    </div>
                  </div>
              ...
              {/* Option 2: Passkey (Face ID / Fingerprint) */}
              <button
                type="button"
                disabled={wallet.isConnecting}
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-zinc-800/70 text-zinc-300 text-xl ring-1 ring-zinc-700/60">
                      💻
                    </div>
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[10px] text-zinc-500">PC / Extensión</span>
                      </div>
                      <p className="text-[11px] sm:text-xs text-zinc-400 mt-0.5">
                        Extensión oficial para Chrome, Brave y Firefox.
                      </p>
                    </div>
                  </div>
